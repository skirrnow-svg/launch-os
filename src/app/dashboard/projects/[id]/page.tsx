    ...
    <div className="max-w-2xl">
      ...
      <nav className="mt-3 flex flex-wrap gap-2">
        {[
          ...
          <Link
            key={s.slug}
            href={`/dashboard/projects/${id}/${s.slug}`}
            className="rounded-full border border-slate-200 px-3 py-1 text-sm font-semibold text-indigo-600 hover:border-indigo-400"
          >
            {s.label}
          </Link>
        ))}
